export default function Vogue() {
  return (
    <div className="relative min-h-screen overflow-hidden" style={{ fontFamily: "'Source Serif 4', Georgia, serif", background: "#f5e8de" }}>
      ...
      <div className="relative z-10 flex min-h-screen flex-col">
        ...
        <div className="text-center pt-12">
          ...
          <div className="mt-2 text-[13px] font-semibold uppercase tracking-[0.5em] text-white/90">April · Portrait Issue · N°74</div>
        </div>
        ...
        <div className="absolute top-[20%] right-8 text-[10px] font-mono text-white/80 tracking-wider">5 · 03 2026 · $14</div>

        {/* left cover lines */}
        <div className="absolute left-8 top-[32%] max-w-[220px] space-y-5 text-white">
          <div>
            <div className="text-[10px] font-bold uppercase tracking-[0.3em] opacity-70">Exclusive</div>
            <div className="mt-1 text-2xl font-semibold leading-tight italic">Anaïs, at last.</div>
          </div>
          <div>
            <div className="text-[10px] font-bold uppercase tracking-[0.3em] opacity-70">Essay</div>
            <div className="mt-1 text-lg font-medium leading-snug">On the quiet power of a single sentence.</div>
          </div>
          <div>
            <div className="text-[10px] font-bold uppercase tracking-[0.3em] opacity-70">Portfolio</div>
        ...
        <div className="absolute right-8 top-[36%] max-w-[200px] space-y-5 text-right text-white">
          <div>
            <div className="text-[10px] font-bold uppercase tracking-[0.3em] opacity-70">Profile</div>
            <div className="mt-1 text-xl font-medium italic leading-snug">"I only photograph what I can't explain."</div>
          </div>
          <div>
            <div className="text-[10px] font-bold uppercase tracking-[0.3em] opacity-70">Travel</div>
        ...
        <div className="relative z-10 bg-black px-10 py-6 text-white">
          <div className="flex items-end justify-between">
            <div>
              <div className="text-[11px] font-bold uppercase tracking-[0.4em] text-white/50">Cover Story</div>
            ...
            <div className="text-right">
              <div className="text-[10px] uppercase tracking-wider text-white/50">Photographed by</div>
