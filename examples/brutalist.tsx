export default function Brutalist() {
  return (
    <div className="min-h-screen bg-[#fef08a] p-10" style={{ fontFamily: "'Inter', sans-serif" }}>
      <div className="border-[6px] border-black bg-white">
        ...
        <div className="flex items-center justify-between border-b-[6px] border-black bg-black px-6 py-3 text-white">
          <span className="text-[11px] font-black uppercase tracking-[0.3em]">No. 14 / Spring</span>
          <span className="text-[11px] font-black uppercase tracking-[0.3em]">Est. 2019</span>
        </div>
        {/* giant title */}
        ...
        <div className="grid grid-cols-12 border-b-[6px] border-black">
          <div className="col-span-4 border-r-[6px] border-black bg-[#fb7185] p-6">
            <div className="text-[10px] font-black uppercase tracking-[0.25em]">Feature</div>
          ...
          <div className="col-span-3 flex flex-col items-center justify-center bg-black p-6 text-center text-white">
            <div className="text-[11px] font-black uppercase tracking-[0.3em]">Page</div>
            <div className="mt-1 text-[140px] font-black leading-none tabular-nums">42</div>
            <div className="text-[11px] uppercase tracking-[0.3em] text-white/60">of 96</div>
          </div>
        </div>
        {/* metric row */}
        <div className="grid grid-cols-4">
          {[
            ...
            <div key={i} className={`border-r-[6px] border-black p-5 ${i === 3 ? "border-r-0" : ""}`}>
              ...
              <div className="mt-1 text-[11px] font-black uppercase tracking-[0.25em]">{l}</div>
            </div>
          ))}
        </div>
      </div>
      {/* footer */}
      <div className="mt-6 flex items-center justify-between border-[6px] border-black bg-white px-6 py-3 text-[11px] font-black uppercase tracking-[0.3em]">
        <span>■ Volume One</span>
        <span>Printed in black</span>
        <span>$0 · free ideas</span>
      </div>
    </div>
  );
}
